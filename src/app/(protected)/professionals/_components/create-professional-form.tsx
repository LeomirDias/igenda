        ...
        try {
            ...
            if (avatarFile) {
                ...
                try {
                    ...
                    await uploadProfessionalProfilePicture(formData, result.professionalId);
                } catch (error) {
                    console.error("Erro ao fazer upload da imagem:", error);
                    toast.error("Erro ao fazer upload da imagem. O profissional foi criado, mas a imagem não foi salva.");
                } finally {
            ...
            toast.error("Erro ao cadastrar profissional. Por favor, tente novamente.");
        }
    };
